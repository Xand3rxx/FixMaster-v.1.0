...
var categoryServicesEdit = $('#get_category_services_edit_url').attr('data-categoryServicesEdit');
var token = $('.get_token').attr('data-token');
var get_category_edit = $('#get_category_edit_url').attr('data-category-edit');
var enity_client_edit = $('#get_client_users_edit_url').attr('data-client-edit');
