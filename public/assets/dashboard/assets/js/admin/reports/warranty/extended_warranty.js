...
// console.log( $jobIdList, 'weddd');
  ...
  $('#date-to').change(function() {
    ...
    if ($.trim($dateFrom).length == 0) {
      ...
      sortJobAssignedTable($sortLevel,  $userId = null, $jobId=null, $lgaIdList =null,   $catIdList=null, $jobClaim=null ,$jobStatus = null, $dateFrom, $dateTo);
    }
  });
  ...
  $('#job-claims').change(function() {
    ...
    sortJobAssignedTable($sortLevel,  $userId = null, $jobStatus=null, $jobId=null,   $catIdList=null,  $jobClaim, $dateFrom = null, $dateTo = null);
  });
