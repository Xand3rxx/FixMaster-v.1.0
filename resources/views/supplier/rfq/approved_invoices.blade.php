...
@section('title', 'Approved Invoices')
      ...
      <div>
        <nav aria-label="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="{{ route('admin.index', app()->getLocale()) }}">Dashboard</a></li>
            ...
            <li class="breadcrumb-item active" aria-current="page">Approved Invoices</li>
          </ol>
        </nav>
        <h4 class="mg-b-0 tx-spacing--1">Approved Invoices </h4>
      </div>
    </div>
      ...
      <div class="col-lg-12 col-xl-12 mg-t-10">
        <div class="card mg-b-10">
          <div class="card-header pd-t-20 d-sm-flex align-items-start justify-content-between bd-b-0 pd-b-0">
            <div>
              <h6 class="mg-b-5">Approved Invoice's as of {{ date('M, d Y') }}</h6>
              <p class="tx-13 tx-color-03 mg-b-0">This table displays a list of all Invoices approved regarding RFQ's initiated by CSE's.</p>
            </div>
                    ...
                    <div class="dropdown-file">
                      ...
                      <div class="dropdown-menu dropdown-menu-right">
                        ...
                        @if($rfq->rfq->accepted != 'Yes')
                          @if(!empty($rfq['rfq']['rfqPayment']['status']) && $rfq['rfq']['rfqPayment']['status'] == 'success')
