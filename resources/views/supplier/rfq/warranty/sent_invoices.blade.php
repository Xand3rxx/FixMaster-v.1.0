      ...
      <div>
        <nav aria-label="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="{{ route('admin.index', app()->getLocale()) }}">Dashboard</a></li>
            <li class="breadcrumb-item" aria-current="page">Warranty RFQ</li>
            <li class="breadcrumb-item active" aria-current="page">Warranty Sent Invoices</li>
          </ol>
        </nav>
        <h4 class="mg-b-0 tx-spacing--1">Warranty Sent Invoices </h4>
      </div>
    </div>
      ...
      <div class="col-lg-12 col-xl-12 mg-t-10">
        <div class="card mg-b-10">
          <div class="card-header pd-t-20 d-sm-flex align-items-start justify-content-between bd-b-0 pd-b-0">
            <div>
              <h6 class="mg-b-5">Warranty Sent Invoice's as of {{ date('M, d Y') }}</h6>
              <p class="tx-13 tx-color-03 mg-b-0">This table displays a list of all Invoices you sent regarding Warranty RFQ's initiated by CSE's.</p>
            </div>
                  ...
                  <td class=" text-center">
                    <div class="dropdown-file">
                      ...
                      <div class="dropdown-menu dropdown-menu-right">
                        ...
                        @if($rfq->accepted == 'Yes' && is_null($rfq->supplierDispatch))
    ...
    <div class="modal-dialog modal-dialog-centered wd-sm-650" role="document">
      <div class="modal-content">
        <div class="modal-body pd-x-25 pd-sm-x-30 pd-t-40 pd-sm-t-20 pd-b-15 pd-sm-b-20">
          ...
          <form method="POST" action="{{ route('supplier.warranty_store_dispatch', app()->getLocale()) }}">
            @csrf
