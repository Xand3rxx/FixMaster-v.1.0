                    ...
                    <div class="tab-content bd bd-gray-300 bd-t-0 pd-20" id="myTabContent3">
                        <div class="tab-pane fade show active" id="description3" role="tabpanel" aria-labelledby="description-tab3">
                            ...
                            <div class="card-body pd-20 pd-lg-25">
                                <form action="{{ route('cse.profile.update', [app()->getLocale()]) }}" method="post" role="form" enctype="multipart/form-data">
                                    @csrf @method('PATCH')
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="bank_id" id="bank_id" class="form-control @error('bank_id') is-invalid @enderror" required>
                                                <option selected value="{{ $user['account']['bank']['id'] }}">{{ $user['account']['bank']['name'] }}</option>
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea id="user_address" rows="3" class="user_address form-control @error('full_address') is-invalid @enderror" name="full_address" autofocus>{{ $user['contact']['address'] }}</textarea>
                                            @error('full_address')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                        ...
                        <div class="tab-pane fade" id="rfq3" role="tabpanel" aria-labelledby="rfq-tab3">
                            ...
                            <div class="card-body pd-20 pd-lg-25">
                                <form action="{{route('cse.profile.change-password', app()->getLocale())}}" method="post">
                                    @csrf
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
