                    ...
                    <tbody>
                        <tr>
                            <td style="padding: 48px 24px 0; color: #161c2d; font-size: 18px; font-weight: 600;">
                                Hello, {{ Str::title($user['account']['first_name'].' '.$user['account']['last_name']) }}
                            </td>
                        </tr>
                        <tr>
                            <td style="padding: 15px 24px 15px; color: #8492a6;">
                                To complete your password reset process, simply click the link in the email we just sent to <a href="mailto: {{$user['email']}}" class="text-primary">{{$user['email']}}</a>
                            </td>
                        </tr>
