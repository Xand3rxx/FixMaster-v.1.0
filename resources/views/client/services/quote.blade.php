...
@section('title', 'Service Quote for '. (!empty($service->name) ? $service->name : 'UNAVAILABLE'). ' Service')
@section('content')
                ...
                <div class="col-lg-12 col-md-12 mt-4 pt-2">
                    <div class="media key-feature align-items-center p-3 rounded shadow text-primary">
                        ...
                        <div class="media-body">
                            <h4 class="title mb-0">{{ !empty($service->name) ? $service->name : 'UNAVAILABLE' }} Service</h4>
                            <small class="text-small"><i class="mdi mdi-star_rate"></i> Total Requests: {{ $service->serviceRequests()->count() ?? '0' }}</small>
                        </div>
                    </div>
                </div><!--end col-->
            </div>
