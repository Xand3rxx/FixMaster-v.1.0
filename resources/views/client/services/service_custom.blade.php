...
<div class="row mt-4">
    ...
    <div class="col-md-6 form-group">
        <div class="custom-control custom-radio form-group position-relative">
            <input type="radio" id="wallet_payment_option" name="payment_channel" class="custom-control-input input-check" onclick="displayPaymentGateways('1')" checked value="Wallet" data-tabid="ewallet" data-action="{{route('wallet-submit', app()->getLocale()) }}"/>
