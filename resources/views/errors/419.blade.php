...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <head>
    ...
    <title>419 | FixMaster.ng - We Fix, You Relax!</title>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-12 text-center">
                    ...
                    <div class="text-capitalize text-dark mb-4 error-page">Page Expired</div>
            ...
            <div class="row">
                ...
                <a href="{{ route('frontend.index',app()->getLocale()) }}" class="btn btn-outline-primary mt-4">Refresh</a>
