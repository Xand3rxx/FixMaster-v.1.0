  ...
  <div class="container pd-x-0">
    ...
    <div class="col-lg-12 col-xl-12 mg-t-10">
      <div class="card mg-b-10">
                ...
                <td class=" text-center">
                  <div class="dropdown-file">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                      ...
                      <a href="{{ route('admin.warranty_details', ['warranty'=>$warranty->service_request->uuid, 'locale'=>app()->getLocale()]) }}"
                        class="dropdown-item details text-primary"><i class="far fa-clipboard"></i> Details</a>
                      @if($warranty->expiration_date < Carbon\Carbon::now()) @if($warranty->has_been_attended_to == 'Yes')
                        ...
                        @else
                        <a href="#markAsResolved" id="markas-resolved" data-toggle="modal"
        ...
        <div class="modal fade" id="markAsResolved" tabindex="-1" role="dialog" aria-hidden="true" data-keyboard="false"
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="form-group position-relative">
                        ...
                        <textarea name="comment" id="reason" rows="3"
      ...
      <div class="modal fade" id="resolvedDetails" tabindex="-1" role="dialog" aria-hidden="true" data-keyboard="false"
        data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
          <div class="modal-content rounded shadow border-0">
            <div class="modal-header">
    ...
    <div class="modal fade" id="assignCse" tabindex="-1" role="dialog" aria-hidden="true" data-keyboard="false"
      data-backdrop="static">
      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
