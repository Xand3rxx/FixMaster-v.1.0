...
<div class="content-body">
    <div class="container pd-x-0">
        <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
            <div>
                ...
                <h4 class="mg-b-0 tx-spacing--1">Edit Loyalty Point</h4>
            </div>
        ...
        <form id="loyaltyForm" method="POST" action="{{ route('admin.loyalty_store_edit', app()->getLocale()) }}"
            ...
            <div class="row row-xs">
                <div class="col-md-12">
                    ...
                    <input type="number" class="form-control custom-input-1" id="sum"
                        ...
                        value="{{ $status->amount}}" autocomplete="off">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" min="0.1" step="any" id="points" class="form-control" name="points" value="{{ $status->points }}"
                    ...
                    <div class="form-group col-md-6" >
                            ...
                            @enderror
                            <input type="hidden" value="{{$status->id}}" name="loyalty_id"/>
                            <input type="hidden" value="{{$status->uuid}}" name="loyalty_uuid"/>
                            <input type="hidden" value="{{$status->amount}}" name="edit_amount"/>
                            <input type="hidden" value="{{$status->client_id}}" name="edit_client"/>
 ...
 <input type="hidden"  data-users-edit="{{ route('admin.loyalty_users_edit',app()->getLocale()) }}" id="get_users_edit_url" />
...
<script src="{{ asset('assets/dashboard/assets/js/admin/loyalty/3d5e497c-d12d-43ec-ac7a-a14f825ffaed.js') }}"></script>
