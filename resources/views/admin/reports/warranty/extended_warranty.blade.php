            ...
            <div class="col-lg-12 col-xl-12 mg-t-10">
              <div class="card mg-b-10">
                ...
                <div class="row mt-1 mb-1 ml-1 mr-1">
                  <div class="col-md-4">
                  <input type="hidden" class="d-none" id="route" value="{{ route('admin.extended_warranty_list_report_sorting', app()->getLocale()) }}">
                ...
                <div class="table-responsive">
                  <div id="job-assigned-sorting">
                    @include('admin.reports.warranty.tables._extended_warranty_claims')
                  </div>
