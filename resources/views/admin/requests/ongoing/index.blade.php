...
@section('title', 'All Ongoing Service Requests')
            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Ongoing Requests</li>
                    </ol>
                </nav>
                <h4 class="mg-b-0 tx-spacing--1">Ongoing Service Requests</h4>
            </div>
        </div>
                ...
                <div class="card mg-b-10">
                    <div class="card-header pd-t-20 d-sm-flex align-items-start justify-content-between bd-b-0 pd-b-0">
                        <div>
                            ...
                            <p class="tx-13 tx-color-03 mg-b-0">This table displays a list of all <strong>Ongoing Service Requests</strong> with assumed initial payments made by the clients.</p>
                        </div>
