...
@section('title', 'All Cancelled Service Requests')
    ...
    <div class="container pd-x-0">
        <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
            <div>
                ...
                <h4 class="mg-b-0 tx-spacing--1">Cancelled Service Requests</h4>
            </div>
        </div>
                ...
                <div class="card mg-b-10">
                    <div class="card-header pd-t-20 d-sm-flex align-items-start justify-content-between bd-b-0 pd-b-0">
                        <div>
                            ...
                            <p class="tx-13 tx-color-03 mg-b-0">This table displays a list of all <strong>Cancelled Service Requests</strong> with assumed initial payments made by the clients.</p>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td class=" text-center">
                                        <div class="dropdown-file">
                                            ...
                                            <a href="{{ route('admin.requests-cancelled.show', ['requests_cancelled'=>$request['uuid'], 'locale'=>app()->getLocale()]) }}" class="dropdown-item text-primary"><i class="far fa-clipboard"></i> Details</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
