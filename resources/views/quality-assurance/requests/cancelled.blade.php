      ...
      <div class="col-lg-12 col-xl-12 mg-t-10">
        <div class="card mg-b-10">
          <div class="card-header pd-t-20 d-sm-flex align-items-start justify-content-between bd-b-0 pd-b-0">
            ...
            <p class="tx-13 tx-color-03 mg-b-0">This table displays a list of all Service Requests you have worked on but has been cancelled by the Customer or Admin</p>
            </div>
            ...
            <div class="d-sm-flex">
              <div class="media">
                ...
                <div class="media-body">
                  ...
                  <h4 class="tx-20 tx-sm-18 tx-md-20 tx-normal tx-rubik mg-b-0">{{$cancelledJobs->count()}}</h4>
                </div>
              </div>
              ...
              <table class="table table-hover mg-b-0" id="basicExample">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('quality-assurance.requests.active_details', [$data->service_request->uuid, 'locale' => app()->getLocale()]) }}" class="btn btn-primary btn-sm">Details</a>
                        </td>
                    </tr>
                    @endforeach
                  </tbody>
