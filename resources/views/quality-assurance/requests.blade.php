                        ...
                        <div class="card-header pd-t-20 d-sm-flex align-items-start justify-content-between bd-b-0 pd-b-0">
                            <div>
                                ...
                                <p class="tx-13 tx-color-03 mg-b-0">This table displays a list of all <strong>Service
                                        Requests</strong> assigned to you by FixMaster Administrator or Customer Service
                                    Executive after careful understudy of each request and with assumed initial payments
                                    made by the clients.</p>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($results as $serviceRequest)
                                        <tr>
                                            ...
                                            <td class="tx-medium">
                                                {{ $serviceRequest->service_request->clientAccount->first_name }}
                                                {{ $serviceRequest->service_request->clientAccount->last_name }}</td>
                                            <td class="tx-medium">
                                            ...
                                            <td class="text-medium">
                                                {{ Carbon\Carbon::parse($serviceRequest->service_request->created_at, 'UTC')->isoFormat('MMMM Do YYYY, h:mm:ssa') }}
                                            </td>
                                            <td class=" text-center">
                                                <div class="dropdown-file">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a href="{{ route('quality-assurance.request_details', [$serviceRequest->service_request->uuid, 'locale' => app()->getLocale()]) }}"
                                                            class="dropdown-item details"><i class="far fa-clipboard"></i>
                                                            Details</a>
                                                    </div>
                                                </div>
                                            </td>
