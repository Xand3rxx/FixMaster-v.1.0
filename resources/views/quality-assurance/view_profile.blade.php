            ...
            <div id="contactInformation" class="tab-pane show active pd-20 pd-xl-25">
              ...
              <div class="row row-sm">
                ...
                <div class="col-6 col-sm-4">
                  ...
                  <p class="tx-primary tx-rubik mg-b-0">{{$user->contact->phone_number??'Unavailable'}}</p>
                </div>
                <div class="col-6 col-sm-4">
                  <label class="tx-10 tx-medium tx-spacing-1 tx-color-03 tx-uppercase tx-sans mg-b-10">Date Created</label>
                  <p class="tx-primary tx-rubik mg-b-0">{{ Carbon\Carbon::parse($user->created_at, 'UTC')->isoFormat('MMMM Do YYYY') }}</p>
                </div>
                <div class="col-sm-6 mg-t-20 mg-sm-t-30">
                  ...
                  <p class="mg-b-0">{{$user->contact->address??'Unavailable'}}</p>
                </div>
                <div class="col-sm-6 mg-t-20 mg-sm-t-30">
              ...
              <div class="row row-sm">
                <div class="col-6 col-sm-6">
                  ...
                  <p class="tx-primary mg-b-0">{{$user->account->bank->name??'Unavailable'}}</p>
                </div>
                <div class="col-sm-6">
                  <label class="tx-10 tx-medium tx-spacing-1 tx-color-03 tx-uppercase tx-sans mg-b-10">Account Number</label>
                  <p class="tx-primary mg-b-0">{{$user->account->account_number??'Unavailable'}}</p>
                </div>
