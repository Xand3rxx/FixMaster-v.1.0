...
@section('title', Auth::user()->type->role->name.' Dashboard' ?? 'Technicians')
                ...
                <div class="row">
                  <div class="col-sm-6 col-lg-12">
                    ...
                    <div class="d-flex align-items-end justify-content-between mg-b-5">
                      <h5 class="tx-normal tx-rubik lh-2 mg-b-0">{{Auth::user()->serviceRequests->count()}}</h5>
                  ...
                  <div class="col-sm-6 col-lg-12 mg-t-30 mg-sm-t-0 mg-lg-t-30">
                    ...
                    <div class="d-flex justify-content-between mg-b-5">
                      <h5 class="tx-normal tx-rubik mg-b-0">{{Auth::user()->serviceCompleted->count() ?? ''}}</h5>
                    </div>
                    <div class="progress ht-4 mg-b-0 op-5">
                  ...
                  <div class="col-sm-6 col-lg-12 mg-t-30">
                    ...
                    <div class="d-flex justify-content-between mg-b-5">
                      <h5 class="tx-normal tx-rubik mg-b-0">{{Auth::user()->serviceCancelled->count() ?? ''}}</h5>
